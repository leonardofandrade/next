"""
Service for CaseProcedure business logic
"""
...
class CaseProcedureService(BaseService):
    """Service for CaseProcedure business logic"""
    
    model_class = CaseProcedure
    
    def get_queryset(self) -> QuerySet:
        """Get CaseProcedure queryset with related data"""
        return super().get_queryset().select_related(
            'case',
            'procedure_category'
        )
    
    def validate_business_rules(self, data: Dict[str, Any], instance: Optional[CaseProcedure] = None) -> Dict[str, Any]:
        """Validate CaseProcedure business rules"""
        # Adiciona validações de negócio se necessário
        return data
    
    def update(self, pk: int, data: Dict[str, Any]) -> CaseProcedure:
        """Update case procedure with version increment"""
